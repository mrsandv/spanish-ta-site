...
if (!function_exists('mkd_styles')) {
	...
	function mkd_styles() {
        ...
        if (file_exists(dirname(__FILE__) ."/css/style_dynamic.css") && mkd_is_css_folder_writable() && !is_multisite()) {
...
if (!function_exists('mkd_scripts')) {
	...
	function mkd_scripts() {
	   ...
	   //include google map api script
        ...
        wp_enqueue_script("mkd_default", MIKADO_ROOT."/js/default.js", array(), false, true);
...
if ( ! function_exists( 'mkd_is_gutenberg_installed' ) ) {
	/**
	 * Function that checks if Gutenberg plugin installed
	 */
	function mkd_is_gutenberg_installed() {
...
add_action( 'admin_enqueue_scripts', 'mkd_is_gutenberg_installed' );