...
if (isset($mkd_options['blog_spotlight_show_categories'])){
	$blog_show_categories = $mkd_options['blog_spotlight_show_categories'];
}

$blog_show_comments = "yes";
if (isset($mkd_options['blog_spotlight_show_comments'])){
    $blog_show_comments = $mkd_options['blog_spotlight_show_comments'];
}
$blog_show_author = "yes";
if (isset($mkd_options['blog_spotlight_show_author'])){
    $blog_show_author = $mkd_options['blog_spotlight_show_author'];
}
$blog_show_like = "yes";
if (isset($mkd_options['blog_spotlight_show_like'])) {
    $blog_show_like = $mkd_options['blog_spotlight_show_like'];
}
$blog_show_ql_icon_mark = "yes";
$blog_title_holder_icon_class = "";
if (isset($mkd_options['blog_spotlight_show_ql_mark'])) {
    $blog_show_ql_icon_mark = $mkd_options['blog_spotlight_show_ql_mark'];
}
...
$blog_show_date = "yes";
if (isset($mkd_options['blog_spotlight_show_date'])) {
    $blog_show_date = $mkd_options['blog_spotlight_show_date'];
}
$blog_show_social_share = "no";
$blog_social_share_type = "dropdown";
if(isset($mkd_options['blog_spotlight_select_share_option'])){
	$blog_social_share_type = $mkd_options['blog_spotlight_select_share_option'];
}
if (isset($mkd_options['enable_social_share'])&& ($mkd_options['enable_social_share']) =="yes"){
    if (isset($mkd_options['post_types_names_post'])&& $mkd_options['post_types_names_post'] =="post"){
        if (isset($mkd_options['blog_spotlight_show_share'])&& $blog_social_share_type == "dropdown") {
            $blog_show_social_share = $mkd_options['blog_spotlight_show_share'];
        }
    }
}

$show_read_more_button = "yes";
if(isset($mkd_options['blog_spotligh_read_more_button']) && $mkd_options['blog_spotligh_read_more_button'] !== '') {
	$show_read_more_button = $mkd_options['blog_spotligh_read_more_button'];
}
$blog_ql_background_image = "no";
if(isset($mkd_options['blog_spotlight_ql_background_image'])){
	$blog_ql_background_image = $mkd_options['blog_spotlight_ql_background_image'];
}
                    ...
                    <div class="post_text_inner">         
						...
						<?php if($blog_show_author == "yes" || $blog_show_date == "yes" || $blog_show_social_share == "yes" || $blog_show_categories == "yes" || $blog_show_comments == "yes" || $blog_show_like == "yes") { ?>	
								<div class="post_info">
									...
									if(isset($mkd_options['blog_spotlight_show_share']) && $mkd_options['blog_spotlight_show_share'] == "yes" && $blog_social_share_type == "list") { ?>
										<div class="social_share_list_wrapper">
											<span class="share_text"><?php echo __("Share", "mkd") ?></span>
