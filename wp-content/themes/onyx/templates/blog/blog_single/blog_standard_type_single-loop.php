...
if (isset($mkd_options['blog_single_show_comments'])) {
    $blog_show_comments = $mkd_options['blog_single_show_comments'];
}
$blog_show_author = "yes";
if (isset($mkd_options['blog_author_info'])) {
    $blog_show_author = $mkd_options['blog_author_info'];
}
$blog_show_like = "yes";
if (isset($mkd_options['blog_single_show_like'])) {
    $blog_show_like = $mkd_options['blog_single_show_like'];
}
$blog_show_date = "yes";
if (isset($mkd_options['blog_single_show_date'])) {
    $blog_show_date = $mkd_options['blog_single_show_date'];
}

$blog_social_share_type = "dropdown";
if(isset($mkd_options['blog_single_select_share_option'])){
	$blog_social_share_type = $mkd_options['blog_single_select_share_option'];
}
...
if (isset($mkd_options['enable_social_share'])&& ($mkd_options['enable_social_share']) =="yes"){
    if (isset($mkd_options['post_types_names_post'])&& $mkd_options['post_types_names_post'] =="post"){
        if (isset($mkd_options['blog_single_show_social_share'])) {
            $blog_show_social_share = $mkd_options['blog_single_show_social_share'];
        }
    }
}
$blog_show_categories = "yes";
if (isset($mkd_options['blog_single_show_category'])) {
    $blog_show_categories = $mkd_options['blog_single_show_category'];
}
$blog_show_ql_icon = "yes";
$blog_title_holder_icon_class = "";
if (isset($mkd_options['blog_single_show_ql_icon'])) {
    $blog_show_ql_icon = $mkd_options['blog_single_show_ql_icon'];
}
                 ...
                 <div class="post_text">
                    <div class="post_text_inner">         
						...
						<?php if($blog_show_author == "yes" || $blog_show_date == "yes" || $blog_show_social_share == "yes" || $blog_show_categories == "yes" || $blog_show_comments == "yes" || $blog_show_like == "yes") { ?>	
							<div class="post_info">
								<?php mkd_post_info(array('date' => $blog_show_date, 'author' => $blog_show_author, 'category' => $blog_show_categories, 'comments' => $blog_show_comments, 'like' => $blog_show_like));
								if($blog_social_share_type == "dropdown"){
									mkd_post_info(array('share' => $blog_show_social_share));			
								}?>
								<?php if(isset($mkd_options['blog_single_show_social_share']) && $mkd_options['blog_single_show_social_share'] == "yes" && $blog_social_share_type == "list") { ?>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            <div class="post_content_holder">
                <div class="post_text_columns">
					<div class="post_text<?php echo esc_attr($background_image_html_class); ?>" <?php mkd_inline_style($background_image_html); ?>>
						<div class="post_text_inner">
