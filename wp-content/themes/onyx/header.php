    ...
    if(isset($mkd_options['back_to_top_position']) && !empty($mkd_options['back_to_top_position'])) {
		...
		<a id='back_to_top' class="<?php echo esc_attr($mkd_back_to_top_button_styles);?>" href='#'>
			<span class="mkd_icon_stack">
				<?php if(isset($mkd_options['show_back_button_icon']) && $mkd_options['show_back_button_icon']!== '') { ?>				
				<span <?php mkd_class_attribute($mkd_options['show_back_button_icon'])?>></span>
				<?php } else {
					$mkdIconCollections->getBackToTopIcon('font_elegant');
				} ?>
			</span>
		</a>
<?php } ?>
