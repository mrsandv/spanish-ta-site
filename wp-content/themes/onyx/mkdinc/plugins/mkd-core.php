...
add_action( 'tgmpa_register', 'mkd_register_mkd_core' );
/**
 ...
 */
function mkd_register_mkd_core() {
    /**
    ...
    $plugins = array(
        ...
        array(
            'name'			=> 'Mikado Core', // The plugin name
            'slug'			=> 'mikado-core', // The plugin slug (typically the folder name)
            'source'			=> get_template_directory() . '/plugins/mikado-core.zip', // The plugin source
