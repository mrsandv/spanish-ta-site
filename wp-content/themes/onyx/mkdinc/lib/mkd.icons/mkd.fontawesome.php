...
class MikadoIconsFontAwesome implements iIconCollection {
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = MIKADO_ROOT . "/css/font-awesome/css/font-awesome.min.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="mkd_icon_font_awesome fa ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
