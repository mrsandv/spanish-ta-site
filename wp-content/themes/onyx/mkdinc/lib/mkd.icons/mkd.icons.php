...
include "mkd.iconcollection.interface.php";
include "mkd.fontawesome.php";
include "mkd.fontelegant.php";
include "mkd.ionicons.php";
include "mkd.lineaicons.php";
include "mkd.simplelineicons.php";

/*
  Class: MikadoIconCollections
...
class MikadoIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new MikadoIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new MikadoIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new MikadoIconsIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new MikadoIconsLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new MikadoSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
    }
    ...
    public function getIconSizeClass($iconSize) {
        switch ($iconSize) {
            case "fa-lg":
                $iconSize = "mkd_tiny_icon";
                break;
            case "fa-2x":
                $iconSize = "mkd_small_icon";
                break;
            case "fa-3x":
                $iconSize = "mkd_medium_icon";
                break;
            case "fa-4x":
                $iconSize = "mkd_large_icon";
                break;
            case "fa-5x":
                $iconSize = "mkd_huge_icon";
                break;
            default:
                $iconSize = "mkd_small_icon";
        }
...
$mkdIconCollections = MikadoIconCollections::get_instance();
